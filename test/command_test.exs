...
defmodule CommandTest do
  ...
  test "shall encode metadata" do
    ...
    assert <<11, 83, 111, 99, 107, 101, 116, 45, 84, 121, 112, 101, 0, 0, 0, 6, 83, 69, 82, 86,
             69, 82>> = encoded
  end
  ...
  test "shall encode ready" do
    ...
    assert <<4, 28, 213, 82, 69, 65, 68, 89, 11, 83, 101, 114, 118, 101, 114, 45, 84, 121, 112,
             101, 0, 0, 0, 6, 83, 69, 82, 86, 69, 82>> = encoded
  end
end
